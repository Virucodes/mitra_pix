...
import 'package:mitra_pix/features/post/domain/repos/post_repo.dart';
...
class PostCubit extends Cubit<PostState> {
  ...
  Future<void> createPost(Post post,
    ...
    try {
      // handle image uplaod for mobile platform (using file path)
      if (imagePath != null) {
        emit(PostsUploading());
        imageUrl = await storageRepo.uploadPostImageMobile(imagePath, post.id);
      }

      // handle image uplaod for web platform (using file bytes)
